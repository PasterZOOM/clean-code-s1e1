...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="task-row-wrapper task"
...
var editTask=function(){
    ...
    if(containsClass){
        ...
        label.className = 'task__label task__label_edit'
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    var taskTitle = listItem.querySelector('.task__title')
    taskTitle.className = 'task__title task_completed'
